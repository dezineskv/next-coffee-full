  ...
  return (
    <div className="px-5 pb-5 md:px-28 md:pb-12">
      <p className="m-auto mt-10 max-w-[740px] text-xs sm:text-base">
        Subscribe to Kimbotic Coffee Newsletter
      </p>
      <form
        className="mx-auto flex max-w-[500px] scale-75 justify-between border border-black shadow-[7px_7px_0_#ccc] sm:scale-100"

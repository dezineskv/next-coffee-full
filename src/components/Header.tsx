...
const Header: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="bg-background mx-auto w-screen">
        <div className="px-auto mx-auto flex flex-col gap-4 py-10 sm:mx-3 sm:w-[90%] sm:px-3 md:flex-row md:items-center md:justify-between">

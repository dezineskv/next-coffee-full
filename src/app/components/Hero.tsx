...
export default function Hero() {
  return (
    <>
      <section className=" bg-gray-200/90 w-full sm:pt-5 md:pt-10 sm:pb-8 md:pl-2 mb-5">
        {/* container */}
        <div className="mx-auto flex flex-col-reverse items-center justify-center gap-10 px-6 md:flex-row md:gap-16 md:px-12">
          {/* TEXT SIDE */}
            <div className="w-full md:w-1/2 sm:px-6">
              ...
              <div className="mt-8 flex flex-col items-start gap-4 sm:flex-row">
                <Button className="h-12 w-full bg-gray-900 text-lg sm:w-auto">
                  Download&nbsp;App
                </Button>
                <Button
                  variant="outline"
